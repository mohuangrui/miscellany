...
//*
//* This script reads in all the valid data in target files and writes data
//* out in a formatted form. It processes each case independently, thus it
...
write(Data_Out_FID,"* Data Formatted *",'(A)');
write(Data_Out_FID,"*******************************************************",'(A)');
...
for n = 1 : Case.Amount
    ...
    //* get the number of cols of each result data, if it > 50, then need to modify: '(50(F12.6))'
