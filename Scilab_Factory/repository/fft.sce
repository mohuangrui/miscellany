...
//*
//* This script reads in specified data and apply Fast Fourier Transformation.
...
write(Data_Out_FID,"* Frequency        SPL(dB)         Peak Amplitude        PSD          SPLA(dBA)        Phase(Radians) *",'(A)');
write(Data_Out_FID,"*******************************************************",'(A)');
...
for n = 1 : Case.Amount
    ...
    //* SPL
    SPL=10*log10(SPL_Core);
    //* PSD
    PSD=10*log10(PSD_Core);
    //* Over all SPL
    ...
    SPLA=SPL+Log_Weight_f+Shift_onek;
