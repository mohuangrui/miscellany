...
//*
//* This script reads in specified data and calculate root mean square based
//* on each column data.
//*
//*                              By Huangrui Mo
//*
...
for n = 1 : Case.Amount
    ...
    Average=sum(Case.Data(1),'r') / (Row.Amount);
    //* initialize purterbation matrix to empty for each case
    Perterbation=[];
    for count = Row.Amount:-1:1
        Perterbation(count,:)=Case.Data(1)(count,:)-Average;
    end
    Case.Rlt(1)=(sum(Perterbation.^2,'r')/Row.Amount).^0.5;
